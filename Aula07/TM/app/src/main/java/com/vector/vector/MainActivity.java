...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText edtTelefones;

    private LinearLayout linearTelefoness;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearTelefoness = findViewById(R.id.linarTele);

        btnAdicionar = findViewById(R.id.btnTele);
        btnAdicionar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                //Cria campo de edtTelefones
                edtTelefones.setHint("Entre com o numero");
                linearTelefoness.addView(edtTelefones);
            }
        });
        ...
        btnInserir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                c.setTelefones(edtTelefones.getText().toString());
                clientes.add(c);
                pos = clientes.size() - 1;
            }
        });
    ...
    private void preencheCampos(){
        if (pos > -1) {
            ...
            edtTelefones.setText(c.getTelefones());
        }else{
            edtCodigo.setText("");
            edtNome.setText("");
            edtEndereco.setText("");
            edtTelefones.setText("");
        }
    }
}
