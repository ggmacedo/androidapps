...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bPrimeiro = findViewById(R.id.btnPrimeiro);
        bSegundo = findViewById(R.id.btnSegundo);
        bTerceiro = findViewById(R.id.btnTerceiro);
        bQuarto = findViewById(R.id.btnQuarto);
        int x=0;
        ...
        bAlterar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for(int i = 0; i < vAlu.size(); i++){
                    vAlu.add(i, eCod.getText().toString());
                    vAlu.add(i, eNome.getText().toString());
                    vAlu.add(i, eEndereco.getText().toString());
                }
